...
<div class="SearchSpace" >
  ...
  <h2>簡単検索</h2>
	...
	<form id="simple_search_form" method="post" action="https://photo.city.edogawa.tokyo.jp/pages/search.php" onSubmit="return CentralSpacePost(this,true);">
        <input type="hidden" name="CSRFToken" value="">
...
jQuery(document).ready(function()
    {
    ActivateHeaderLink("https:\/\/photo.city.edogawa.tokyo.jp%2Fpages%2Fdownload_progress.php%3Fref%3D2593");
...
window.onresize=function()
	...
	<script type="text/javascript">
        window.setTimeout("document.location='https://photo.city.edogawa.tokyo.jp/pages/download.php?ref=2593&size=&ext=jpg&k=&alternative=-1&usage=-1&usagecomment='",1000);
	</script>
...
<div class="BasicsBox">
    ...
    <p>ダウンロードはまもなく開始します。 続けて作業する場合は以下のリンクを使用してください。</p>
		    <p><a onClick="return CentralSpaceLoad(this,true);" href="/pages/view.php?ref=2593&k=&search=&offset=&order_by=&sort=&archive="><i aria-hidden="true" class="fa fa-caret-left"></i>&nbsp;リソース表示へ戻る</a></p>
    <p><a onClick="return CentralSpaceLoad(this,true);" href="/pages/search.php?ref=2593&k=&search=&offset=&order_by=&sort=&archive="><i aria-hidden="true" class="fa fa-caret-left"></i>&nbsp;戻る</a></p>
